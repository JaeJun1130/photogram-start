    ...
    <div class="profileContainer">
        ...
        <div class="profile-left">
            <div class="profile-img-wrap story-border"
                 onclick="popup('.modal-image',${userProfileDto.user.id},${principal.user.id})">
                    ...
                    <c:otherwise>
                        <c:choose>
                            <c:when test="${userProfileDto.subScribeStatus}">
                                <button class="cta blue" onclick="toggleSubscribe(${userProfileDto.user.id},this)">
                                    구독취소
                                </button>
                            </c:when>
                            <c:otherwise>
                                <button class="cta" onclick="toggleSubscribe(${userProfileDto.user.id},this)">구독하기
                                </button>
                            </c:otherwise>
                        </c:choose>
                    </c:otherwise>
    ...
    <div class="profileContainer">
        ...
        <div id="tab-1-content" class="tab-content-item show">
            ...
            <div class="tab-1-content-inner">
                ...
                <!--아이템들-->
                <c:forEach var="image" items="${userProfileDto.user.images}"> <!-- EL표현식 변수를 호출하면 get함수가 호출 -->
                    <div class="img-box">
...
<div class="modal-image" onclick="modalImage()">
    <div class="modal">
        <p>프로필 사진 바꾸기</p>
        <button class="profile-upload-Image"
                onclick="profileImageUpload(${userProfileDto.user.id},${principal.user.id})">사진 업로드
        </button>
